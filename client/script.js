...
$(document).ready(function(){
  ...
  function ajaxCall(httpMethod, url, successFunc) {
    $.ajax({
        type: httpMethod,
        url: url,
        timeout: 5000,
  ...
  function initialData(data){
    toursCollection = data;
    console.log(toursCollection);
    create_table();
  }
  ...
  function create_table(){
    ...
    //go over all the tours
    toursCollection.forEach(function(myDoc) { 
  ...
  function guide_info(event){
    ...
    ajaxCall(GET, TOURS_URL, initialData);
    //sort:==============================================================================================
    $("#sort").change(function () {
     ...
     function sort_date_down(){
        toursCollection.sort(function(a, b) {
